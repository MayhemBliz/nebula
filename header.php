    ...
    <header class="fixed h-40 w-full z-50 <?php echo has_block('acf/hero') ? '' : 'bg-black'; ?>">
        <div class="container flex flex-col py-6">
            <div class="flex justify-between gap-6">
                ...
                <div class="flex flex-col items-end gap-6 mb-6">
                    <nav class="flex gap-6">
                        ...
                        <!-- Mobile Menu Toggle -->
                        <button id="mobile-menu-toggle" class="lg:hidden text-gray-800">
            ...
            <div class="flex justify-end">
                ...
                <div id="mobile-menu" class="fixed inset-y-0 right-0 w-64 shadow-xl bg-white transform translate-x-full transition-transform lg:hidden">
                    <div class="p-6 flex flex-col h-screen">
                        <button id="mobile-menu-close" class="mb-6">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        ?>
                        <ul class="flex flex-col gap-3 lg:gap-6 text-primary font-semibold mt-auto">
                            <li>
                                <form 
                                    role="search" 
                                    method="get" 
                                ...
                                >
                                    ...
                                    <input 
                                        type="search" 
                                        id="search-field" 
                                        class="bg-transparent w-13 focus:w-40 outline-none transition-all duration-300 placeholder-primary" 
                                        placeholder="<?php esc_attr_e('Search...', 'nebula'); ?>" 
                                        value="<?php echo get_search_query(); ?>" 
                                        name="s" 
                                        autocomplete="off" 
                            ...
                            <li>
                                <a href="tel:01234567891" class="top-nav-item flex items-center gap-2">
                                    <i class="flex items-center justify-center h-10 w-10 bg-primary rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-telephone" viewBox="0 0 16 16">
                                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.6 17.6 0 0 0 4.168 6.608 17.6 17.6 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.68.68 0 0 0-.58-.122l-2.19.547a1.75 1.75 0 0 1-1.657-.459L5.482 8.062a1.75 1.75 0 0 1-.46-1.657l.548-2.19a.68.68 0 0 0-.122-.58zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
                                    </svg>
                                    </i>
                                    <span>012 3456 7891</span>
                                </a>
                            </li>
                        </ul>
                    </div>
